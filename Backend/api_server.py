...
# Assumes these are defined/imported elsewhere in your app:
#   - app                : FastAPI instance
#   - processed_documents: dict storing uploaded/processed docs
#   - syllabus_matcher   : SyllabusMatcher instance
#   - SyllabusMatchRequest: Pydantic request model
#   - _article_full_text : helper that extracts plain text from an article dict
